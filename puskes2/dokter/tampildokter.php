...
<body>
    ...
    <div id="content">
	    ...
	    <table border="1" cellpadding="10" cellspacing="0">
	        ...
	        <?php while ($row = mysqli_fetch_assoc($data)) : ?>
	            <tr>
	                ...
	                <td><?= $row["Jadwal"]; ?></td>
	                <td>
	                    <button onclick="openFloatWindow(<?= $row["ID_Dokter"]; ?>, 
	                    								'<?= $row["Nama_D"]; ?>', 
	                    								'<?= $row["Spesialis"]; ?>',
	                    								'<?= $row["Jadwal"]; ?>'
	                    								)">Detail</button>
	    ...
	    <a href="tambahdokter.php?id=<?= $idDokter; ?>">Tambah Dokter</a>
	    ...
	    <script>
	        ...
	        function openFloatWindow(id, nama, spesialis, jadwal) {
	            ...
	            floatWindow.innerHTML = `
	                ...
	                <button onclick="window.location.href='ubahdokter.php?id=${id}'">Ubah Data</button>
	        ...
	        function openNestedFloatWindow(id) {
	            ...
	            nestedFloatWindow.innerHTML = `
	                ...
	                <button onclick="window.location.href='hapusdokter.php?id=${id}'">Hapus</button>
